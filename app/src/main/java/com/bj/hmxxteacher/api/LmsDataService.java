...
import com.bj.hmxxteacher.entity.ArticleInfo;
import com.bj.hmxxteacher.entity.BadgeType;
import com.bj.hmxxteacher.entity.BaseDataInfo;
import com.bj.hmxxteacher.entity.ClassInfo;
import com.bj.hmxxteacher.entity.ClassItemInfo;
import com.bj.hmxxteacher.entity.ClassNewsInfo;
import com.bj.hmxxteacher.entity.CommentInfo;
import com.bj.hmxxteacher.entity.KidClassInfo;
import com.bj.hmxxteacher.entity.KidDataInfo;
import com.bj.hmxxteacher.entity.OrderInfo;
import com.bj.hmxxteacher.entity.SubjectInfo;
import com.bj.hmxxteacher.entity.TeacherInfo;
import com.bj.hmxxteacher.entity.TradeInfo;
import com.bj.hmxxteacher.utils.LL;
import com.bj.hmxxteacher.utils.StringUtils;
import com.bj.hmxxteacher.zzeaseui.model.EaseConversation;
...
import static com.bj.hmxxteacher.api.HttpUtilService.getJsonByPostUrl;
...
public class LmsDataService {
    ...
    public TeacherInfo loginFromAPI2(String phoneNumber, String code) throws Exception {
        ...
        Log.e("登录：1" ,parseUrl);
        String abc = getJsonByPostUrl(parseUrl, params);
        Log.e("登录2" ,abc);
    ...
    public List<ClassItemInfo> getClassAllStudentFromAPI(String classId, String type,
        ...
        if (type.equals("0")) {
            ...
            Log.e("classid==",classId+"orderby="+orderby);
            Log.e("学生列表",result);
            JSONObject resultObj = new JSONObject(result);
            String errorCode = resultObj.optString("ret");
            String errorMsg = resultObj.optString("msg");
        ...
        if (!StringUtils.isEmpty(errorCode) && errorCode.equals("1")) {
            ...
            if (pageIndex.equals("1") && newsArray.length() == 0) {
                ...
                for (int i = 0; i < newsArray.length(); i++) {
                    ...
                    item.setDongtai_pic(itemObj.optString("dongtai_pic"));
    ...
    public String getCommendReasonFromAPI2(String teacherPhoneNumber,String type,String banji_type) throws Exception {
//        String parseUrl = "js/dzliyou";
        Log.e("参数","phone="+teacherPhoneNumber+"type="+type+"bianjitype="+banji_type);
        String parseUrl = "dianzan/dzliyou";
        HashMap<String, String> params = new HashMap<>();
        params.put("teacherphone", teacherPhoneNumber);
        params.put("type", type);
        params.put("banji_type", banji_type);
        String result = getJsonByPostUrl(parseUrl, params);

        Log.e("编辑界面的理由",result);
        JSONObject resultObj = new JSONObject(result);
        String errorCode = resultObj.optString("ret");
        String errorMsg = resultObj.optString("msg");
        String data = resultObj.optString("data");
    ...
    public String[] commendStudentFromAPI(String teacherPhone, String studentId, String reasonId, String position) throws Exception {
        LL.i("评价接口：teacherPhoneNumber" + teacherPhone);
...
//                    xuekeInfo.setSubBadgeCount(Integer.valueOf(xuekeObj.optString("xueke_num")));
                    xuekeInfo.setSubBadgeCount(xuekeObj.optString("xueke_num"));
    ...
    public List<BadgeType> getClassBadgeTypeListFromAPI2(String classId) throws Exception {
        List<BadgeType> badgeTypeList = new ArrayList<>();
        String parseUrl = "js/chznumber";
        HashMap<String, String> params = new HashMap<>();
        params.put("classcode", classId);
...
//                info.setSubBadgeCount(Integer.valueOf(itemObj.optString("xueke_num")));
                info.setSubBadgeCount(itemObj.optString("xueke_num"));
                dataList.add(info);
                info = null;
            }
        }
...
//                info.setSubBadgeCount(Integer.valueOf(itemObj.optString("liyou_num")));
                ...
                if(StringUtils.isEmpty(itemObj.optString("liyou_num"))){
                    info.setSubBadgeCount(itemObj.optString("0"));
                }else {
                    info.setSubBadgeCount(itemObj.optString("liyou_num"));
                }
...
//        String parseUrl = "Jsdzliyou/deldzliyou";
        String parseUrl = "dianzan/deldzliyou";
        HashMap<String, String> params = new HashMap<>();
     ...
     * @throws Exception
     */
    public String[] addTeacherCommendReasonFromAPI(String userPhone, String reasonName,String type) throws Exception {
        String[] result = new String[3];

//        String parseUrl = "Jsdzliyou/setdzliyou";
        String parseUrl = "dianzan/setdzliyou";
        HashMap<String, String> params = new HashMap<>();
