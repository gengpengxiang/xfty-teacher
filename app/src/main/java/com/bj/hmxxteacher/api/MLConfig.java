...
public class MLConfig {
    ...
    public static final String KEY_APP_PKGNAME = "com.bj.hmxxteacher";
//    public static final String KEY_APP_PKGNAME = "com.bj.eduparentstea";
