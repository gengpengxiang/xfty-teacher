...
public class LatestNewsBadgeProAdapter extends BaseRecyclerAdapter<RecyclerView.ViewHolder> {

    private List<ClassNewsInfo> mDataList;

    public LatestNewsBadgeProAdapter(List<ClassNewsInfo> mDataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType, boolean isItem) {
        ...
        if (viewType == ShowType.ITEM_NORMAL.ordinal()) {
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_item_news_empty_badge_pro, parent, false);
