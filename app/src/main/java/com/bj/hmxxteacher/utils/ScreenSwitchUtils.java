package com.bj.hmxxteacher.utils;
...
//                            mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
                            ...
                            if (screenOrientationListener != null) {
                                screenOrientationListener.onChanged(isPortrait);
                            }
                        }
...
//            mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
    ...
    public OnScreenOrientationChangedListener screenOrientationListener;

    public void setScreenOrientationListener(OnScreenOrientationChangedListener screenOrientationListener) {
