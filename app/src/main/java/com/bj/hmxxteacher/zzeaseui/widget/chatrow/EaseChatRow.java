package com.bj.hmxxteacher.zzeaseui.widget.chatrow;
...
import com.bj.hmxxteacher.zzeaseui.adapter.EaseMessageAdapter;
...
public abstract class EaseChatRow extends LinearLayout {
    ...
    protected String currentUserPic;

    protected EaseChatMessageList.MessageListItemClickListener itemClickListener;

    public EaseChatRow(Context context, EMMessage message, int position, BaseAdapter adapter, String currentUserPic) {
        super(context);
    ...
    private void setUpBaseView() {
        ...
        if (message.direct() == Direct.SEND) {
            ...
            EaseUserUtils.setUserAvatar(context, currentUserPic, userAvatarView);
        } else {
            try {
                EaseUserUtils.setUserAvatar(context, message.getStringAttribute("userPhoto"), userAvatarView);
                EaseUserUtils.setUserNick(message.getStringAttribute("userNick"), usernickView);
