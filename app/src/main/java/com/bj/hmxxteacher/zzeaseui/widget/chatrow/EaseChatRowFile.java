...
import com.bj.hmxxteacher.zzeaseui.ui.EaseShowNormalFileActivity;
...
public class EaseChatRowFile extends EaseChatRow {
    ...
    public EaseChatRowFile(Context context, EMMessage message, int position, BaseAdapter adapter, String currUserPic) {
