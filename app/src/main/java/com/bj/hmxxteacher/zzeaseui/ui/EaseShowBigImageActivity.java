...
import com.bj.hmxxteacher.zzeaseui.utils.EaseLoadLocalBigImgTask;
import com.bj.hmxxteacher.zzeaseui.widget.photoview.EasePhotoView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Toast.makeText(EaseShowBigImageActivity.this, "长按事件", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
    }
