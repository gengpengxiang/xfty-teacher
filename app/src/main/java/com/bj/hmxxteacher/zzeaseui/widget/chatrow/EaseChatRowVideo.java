...
import com.bj.hmxxteacher.zzeaseui.ui.EaseShowVideoActivity;
...
public class EaseChatRowVideo extends EaseChatRowFile {
    ...
    public EaseChatRowVideo(Context context, EMMessage message, int position, BaseAdapter adapter, String currUserPic) {
