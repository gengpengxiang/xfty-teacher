...
public class EaseChatRowLocation extends EaseChatRow {
    ...
    public EaseChatRowLocation(Context context, EMMessage message, int position, BaseAdapter adapter, String currUserPic) {
    ...
    protected void onBubbleClick() {
        Toast.makeText(context, "BaiduMap已删除", Toast.LENGTH_SHORT).show();
