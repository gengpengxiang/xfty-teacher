package com.bj.hmxxteacher.zzeaseui.ui;
...
import com.bj.hmxxteacher.zzeaseui.EaseConstant;
import com.bj.hmxxteacher.zzeaseui.controller.EaseUI;
import com.bj.hmxxteacher.zzeaseui.domain.EaseEmojicon;
import com.bj.hmxxteacher.zzeaseui.domain.EaseUser;
import com.bj.hmxxteacher.zzeaseui.model.EaseAtMessageHelper;
import com.bj.hmxxteacher.zzeaseui.utils.EaseCommonUtils;
import com.bj.hmxxteacher.zzeaseui.utils.EaseUserUtils;
import com.bj.hmxxteacher.zzeaseui.widget.EaseAlertDialog;
import com.bj.hmxxteacher.zzeaseui.widget.EaseChatExtendMenu;
import com.bj.hmxxteacher.zzeaseui.widget.EaseChatInputMenu;
import com.bj.hmxxteacher.zzeaseui.widget.EaseChatMessageList;
import com.bj.hmxxteacher.zzeaseui.widget.EaseVoiceRecorderView;
import com.bj.hmxxteacher.zzeaseui.widget.chatrow.EaseCustomChatRowProvider;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected String toChatUserPhoto;

    protected String currUserPhoto;
    protected String currUserNick;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        toChatUserNick = fragmentArgs.getString(EaseConstant.EXTRA_TO_USER_NICK);
        toChatUserPhoto = fragmentArgs.getString(EaseConstant.EXTRA_TO_USER_PHOTO);

        currUserPhoto = fragmentArgs.getString("currUserPhoto");
        currUserNick = fragmentArgs.getString("currUserNick");

        currClassName = fragmentArgs.getString("currClassName");
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            // set title
            titleBar.setTitle(toChatUserNick);
...
//        });
    ...
    protected void onMessageListInit() {
        messageList.init(toChatUsername, chatType, chatFragmentHelper != null ?
                chatFragmentHelper.onSetCustomChatRowProvider() : null, currUserPhoto);
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_PICTURE:
                    ...
                    break;
                case ITEM_LOCATION:
                    Toast.makeText(getActivity(), "BaiduMap已删除", Toast.LENGTH_SHORT).show();
    ...
    protected void sendMessage(EMMessage message) {
        ...
        message.setAttribute(EaseConstant.EXTRA_CURR_USER_NICK, currUserNick);
        message.setAttribute(EaseConstant.EXTRA_CURR_USER_PHOTO, currUserPhoto);

        message.setAttribute(EaseConstant.EXTRA_TO_USER_NICK, toChatUserNick);
        message.setAttribute(EaseConstant.EXTRA_TO_USER_PHOTO, toChatUserPhoto);

        message.setAttribute(EaseConstant.EXTRA_TO_CLASS_NAME, currClassName);
        //send message
    ...
    protected void selectPicFromCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            uri = FileProvider.getUriForFile(getActivity(), getActivity().getPackageName() + ".fileProvider", cameraFile);
        } else {
