package com.bj.hmxxteacher.zzeaseui.widget;
...
public class EaseChatMessageList extends RelativeLayout {
     ...
     */
    public void init(String toChatUsername, int chatType, EaseCustomChatRowProvider customChatRowProvider, String currUserPic) {
        this.chatType = chatType;
        this.toChatUsername = toChatUsername;
        this.currUserPic = currUserPic;
        conversation = EMClient.getInstance().chatManager().getConversation(toChatUsername, EaseCommonUtils.getConversationType(chatType), true);
        messageAdapter = new EaseMessageAdapter(context, toChatUsername, chatType, listView, currUserPic);
