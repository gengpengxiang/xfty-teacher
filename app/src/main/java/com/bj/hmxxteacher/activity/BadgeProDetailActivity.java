...
import com.bj.hmxxteacher.adapter.LatestNewsBadgeProAdapter;
...
import com.bj.hmxxteacher.widget.flowlayout.FlowLayout;
import com.bj.hmxxteacher.widget.flowlayout.TagAdapter;
import com.bj.hmxxteacher.widget.flowlayout.TagFlowLayout;
...
public class BadgeProDetailActivity extends BaseActivity {
    ...
    private LatestNewsBadgeProAdapter mAdapter;
    ...
    private String badgeProTypeId = "00";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_badge_pro_detail);
    ...
    protected void initView() {
        ...
        mTagFlowLayout.setOnTagClickListener(new TagFlowLayout.OnTagClickListener() {
            ...
            public boolean onTagClick(View view, int position, FlowLayout parent) {
                ...
                badgeProTypeId = mSubjectList.get(position).getSubID();
        ...
        // set Adatper
        mAdapter = new LatestNewsBadgeProAdapter(mDataList);
        mAdapter.setOnMyItemClickListener(new LatestNewsBadgeProAdapter.OnMyItemClickListener() {
            @Override
...
//                mXRefreshView.setPullLoadEnable(true);
    ...
    private class MyClassCommendTypeAsyncTask extends AsyncTask<String, Integer, List<SubjectInfo>> {
        ...
        protected List<SubjectInfo> doInBackground(String... params) {
            ...
            try {
                newList = mService.getClassBadgeProTypeFromAPI(classId);
            } catch (Exception e) {
                e.printStackTrace();
        ...
        protected void onPostExecute(List<SubjectInfo> subjectInfos) {
            if (subjectInfos == null) {
                T.showShort(BadgeProDetailActivity.this, "服务器开小差了，请待会重试");
            } else if (subjectInfos.size() == 0) {
                T.showShort(BadgeProDetailActivity.this, "数据异常");
            } else {
    ...
    private class MyClassAllNewsAsyncTask extends AsyncTask<String, Integer, List<ClassNewsInfo>> {
        ...
        protected List<ClassNewsInfo> doInBackground(String... params) {
            ...
            try {
                infoList = mService.getClassBadgeProNewsFromAPI(classId, badgeProTypeId, pageIndex);
            } catch (Exception e) {
                e.printStackTrace();
                LL.e(e);
                infoList = null;
        ...
        protected void onPostExecute(List<ClassNewsInfo> result) {
            ...
            if (result == null) {
                cleanXRefreshView();
                T.showShort(BadgeProDetailActivity.this, "服务器开小差了，请重试");
            } else {
                loadData(result);
            }
        }
    ...
    protected void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("professional");
    ...
    protected void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("professional");
